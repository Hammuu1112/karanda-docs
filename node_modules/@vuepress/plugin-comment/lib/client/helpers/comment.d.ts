...
export declare const useArtalkOptions: () => Ref<ArtalkOptions, ArtalkOptions>;
export declare const defineGiscusConfig: (options: MaybeRefOrGetter<GiscusOptions>) => void;
export declare const useGiscusOptions: () => Ref<GiscusOptions, GiscusOptions>;
export declare const defineTwikooConfig: (options: MaybeRefOrGetter<TwikooOptions>) => void;
export declare const useTwikooOptions: () => Ref<TwikooOptions, TwikooOptions>;
export declare const defineWalineConfig: (options: MaybeRefOrGetter<WalineOptions>) => void;
export declare const useWalineOptions: () => Ref<WalineOptions, WalineOptions>;
