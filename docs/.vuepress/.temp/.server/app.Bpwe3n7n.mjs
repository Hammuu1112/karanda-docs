...
const _sfc_main$1u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    __expose();
    const SearchBox = defineAsyncComponent(() => import("./assets/SearchBox-CADK70BA.mjs"));
...
const sidebar = { "/en/": { "/en/docs/": [{ "text": "Get-started", "prefix": "get-started", "items": [{ "text": "installation", "link": "installation" }] }] }, "/": { "/docs/": [{ "text": "Get-started", "prefix": "get-started", "collapsed": false, "items": "auto" }] }, "__auto__": { "/docs/get-started/": [{ "text": "account", "link": "/docs/get-started/account/", "items": [] }, { "text": "install", "link": "/docs/get-started/installation/", "items": [] }] } };
