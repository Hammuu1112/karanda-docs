...
import { _ as _export_sfc, u as useRouteLocale, a as useLocale, b as useSearchIndex } from "../app.Bpwe3n7n.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, routeLocale, locale, el, resultsEl, searchIndexData, activate, searchIndex, disableQueryPersistence, filterText, buttonText, results, enableNoResults, mark, cache, searchInput, disableReset, focusSearchInput, onSearchBarClick, selectedIndex, disableMouseOver, scrollToSelectedResult, router, isLocked, resetSearch, escapeRegExp, formMarkRegex, BackIcon, ClearIcon, SearchIcon };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ssrRenderTeleport(_push, (_push2) => {
    ...
    _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a = $setup.results) == null ? void 0 : _a.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="mini-search-label" class="VPLocalSearchBox" data-v-f25b3ebe><div class="backdrop" data-v-f25b3ebe></div><div class="shell" data-v-f25b3ebe><form class="search-bar" data-v-f25b3ebe><label id="localsearch-label"${ssrRenderAttr("title", $setup.buttonText)} for="localsearch-input" data-v-f25b3ebe>`);
    _push2(ssrRenderComponent($setup["SearchIcon"], { class: "search-icon" }, null, _parent));
    _push2(`</label><div class="search-actions before" data-v-f25b3ebe><button class="back-button"${ssrRenderAttr("title", $setup.locale.backButtonTitle)} data-v-f25b3ebe>`);
    _push2(ssrRenderComponent($setup["BackIcon"], null, null, _parent));
    _push2(`</button></div><input id="localsearch-input"${ssrRenderAttr("value", $setup.filterText)}${ssrRenderAttr("placeholder", $setup.buttonText)} aria-labelledby="localsearch-label" class="search-input" data-v-f25b3ebe><div class="search-actions" data-v-f25b3ebe><button class="clear-button" type="reset"${ssrIncludeBooleanAttr($setup.disableReset) ? " disabled" : ""}${ssrRenderAttr("title", $setup.locale.resetButtonTitle)} data-v-f25b3ebe>`);
    _push2(ssrRenderComponent($setup["ClearIcon"], null, null, _parent));
    _push2(`</button></div></form><ul${ssrRenderAttr("id", ((_b = $setup.results) == null ? void 0 : _b.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = $setup.results) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = $setup.results) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-f25b3ebe><!--[-->`);
    ssrRenderList($setup.results, (p, index) => {
      _push2(`<li role="option"${ssrRenderAttr("aria-selected", $setup.selectedIndex === index ? "true" : "false")} data-v-f25b3ebe><a${ssrRenderAttr("href", p.id)} class="${ssrRenderClass([{
        selected: $setup.selectedIndex === index
      }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-f25b3ebe><div data-v-f25b3ebe><div class="titles" data-v-f25b3ebe><span class="title-icon" data-v-f25b3ebe>#</span><!--[-->`);
      ssrRenderList(p.titles, (t, i) => {
        _push2(`<span class="title" data-v-f25b3ebe><span class="text" data-v-f25b3ebe>${t ?? ""}</span><svg width="18" height="18" viewBox="0 0 24 24" data-v-f25b3ebe><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18l6-6l-6-6" data-v-f25b3ebe></path></svg></span>`);
      });
      _push2(`<!--]--><span class="title main" data-v-f25b3ebe><span class="text" data-v-f25b3ebe>${p.title ?? ""}</span></span></div></div></a></li>`);
    });
    _push2(`<!--]-->`);
    if ($setup.filterText && !$setup.results.length && $setup.enableNoResults) {
      _push2(`<li class="no-results" data-v-f25b3ebe>${ssrInterpolate($setup.locale.noResultsText)} &quot;<strong data-v-f25b3ebe>${ssrInterpolate($setup.filterText)}</strong>&quot; </li>`);
    } else {
      _push2(`<!---->`);
    }
    _push2(`</ul><div class="search-keyboard-shortcuts" data-v-f25b3ebe><span data-v-f25b3ebe><kbd${ssrRenderAttr("aria-label", ((_e = $setup.locale.footer) == null ? void 0 : _e.navigateUpKeyAriaLabel) ?? "")} data-v-f25b3ebe><svg width="14" height="14" viewBox="0 0 24 24" data-v-f25b3ebe><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m-7 7l7-7l7 7" data-v-f25b3ebe></path></svg></kbd><kbd${ssrRenderAttr("aria-label", ((_f = $setup.locale.footer) == null ? void 0 : _f.navigateDownKeyAriaLabel) ?? "")} data-v-f25b3ebe><svg width="14" height="14" viewBox="0 0 24 24" data-v-f25b3ebe><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m7-7l-7 7l-7-7" data-v-f25b3ebe></path></svg></kbd> ${ssrInterpolate(((_g = $setup.locale.footer) == null ? void 0 : _g.navigateText) ?? "")}</span><span data-v-f25b3ebe><kbd${ssrRenderAttr("aria-label", ((_h = $setup.locale.footer) == null ? void 0 : _h.selectKeyAriaLabel) ?? "")} data-v-f25b3ebe><svg width="14" height="14" viewBox="0 0 24 24" data-v-f25b3ebe><g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-f25b3ebe><path d="m9 10l-5 5l5 5" data-v-f25b3ebe></path><path d="M20 4v7a4 4 0 0 1-4 4H4" data-v-f25b3ebe></path></g></svg></kbd> ${ssrInterpolate(((_i = $setup.locale.footer) == null ? void 0 : _i.selectText) ?? "")}</span><span data-v-f25b3ebe><kbd${ssrRenderAttr("aria-label", ((_j = $setup.locale.footer) == null ? void 0 : _j.closeKeyAriaLabel) ?? "")} data-v-f25b3ebe>esc</kbd> ${ssrInterpolate(((_k = $setup.locale.footer) == null ? void 0 : _k.closeText) ?? "")}</span></div></div></div>`);
  }, "body", false, _parent);
}
...
const SearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f25b3ebe"], ["__file", "SearchBox.vue"]]);
export {
